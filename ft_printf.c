...
/*   Updated: 2022/06/10 17:18:50 by aaslan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief printf için formatı belirlerken kullanılan yardımcı fonksiyon.
 *
 * @param c % işaretinden sonra gelen karakter
 * @param ap Sınırsız değişkenlerin temsilcisi
